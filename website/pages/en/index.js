            ...
            <SplashContainer>
                <div className="inner">
                    ...
                    <PromoSection>
                        ...
                        <Button href="https://github.com/zio/zio-telemetry" target="_blank">GitHub</Button>
                    </PromoSection>
                </div>
            </SplashContainer>
        );
    ...
    render() {
        ...
        const FeatureCallout = () => (
            <div
                ...
                <h2>Welcome to ZIO Telemetry</h2>
                <MarkdownBlock>
                    A ZIO-powered OpenTelemetry library.
                </MarkdownBlock>
        ...
        const Features = () => (
            <Block layout="fourColumn">
                {[
                    {
                        content: 'Collect and send telemetry data without side effects',
                        image: `${baseUrl}img/undraw_tweetstorm.svg`,
                        imageAlign: 'top',
                        title: 'Purely-functional',
                    },
                    {
                        content: 'Fully utilize the compiler to catch bugs at compile time',
